...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(texcaller)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(texcaller)
ZEND_DECLARE_MODULE_GLOBALS(texcaller)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(texcaller_globals_id, zend_texcaller_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(texcaller_globals_id, zend_texcaller_globals *, error_code )
#else
#define SWIG_ErrorMsg() (texcaller_globals.error_msg)
#define SWIG_ErrorCode() (texcaller_globals.error_code)
#endif
...
static void texcaller_init_globals(zend_texcaller_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void texcaller_destroy_globals(zend_texcaller_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_texcaller_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
...
ZEND_NAMED_FUNCTION(_wrap_swig_texcaller_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
ZEND_NAMED_FUNCTION(_wrap_texcaller_convert) {
  ...
  try {
    ...
    (void)_e;
    zend_throw_exception(NULL, const_cast<char*>("C++ std::domain_error exception thrown"), 0 TSRMLS_CC);
    return;
    
  }
  catch(std::runtime_error &_e) {
    (void)_e;
    zend_throw_exception(NULL, const_cast<char*>("C++ std::runtime_error exception thrown"), 0 TSRMLS_CC);
    return;
...
/* arginfo subsection */
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_texcaller_convert, 0, 0, 0)
 ...
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_texcaller_escape_latex, 0, 0, 0)
 ZEND_ARG_PASS_INFO(0)
ZEND_END_ARG_INFO()
...
static zend_function_entry texcaller_functions[] = {
 SWIG_ZEND_NAMED_FE(texcaller_convert,_wrap_texcaller_convert,swig_arginfo_texcaller_convert)
 SWIG_ZEND_NAMED_FE(texcaller_escape_latex,_wrap_texcaller_escape_latex,swig_arginfo_texcaller_escape_latex)
 SWIG_ZEND_NAMED_FE(swig_texcaller_alter_newobject,_wrap_swig_texcaller_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_texcaller_get_newobject,_wrap_swig_texcaller_get_newobject,NULL)
 ZEND_FE_END
};
...
#endif
zend_module_entry texcaller_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"texcaller",
    texcaller_functions,
    PHP_MINIT(texcaller),
    PHP_MSHUTDOWN(texcaller),
    PHP_RINIT(texcaller),
    PHP_RSHUTDOWN(texcaller),
    PHP_MINFO(texcaller),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &texcaller_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &texcaller_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(texcaller)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(texcaller, texcaller_init_globals, texcaller_destroy_globals);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(texcaller_globals_id);
#endif
    return SUCCESS;
}
